                    ...
                    {nets.map(net => {
                        ...
                        return (
                            <tr key={net.id} className="hover:bg-dark-700/30 group cursor-pointer" onClick={() => onViewDetails(net.id)}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-dark-text-secondary">{formatSchedule(net.schedule)} at {formatTime(net.time)} {formatTimeZone(net.time_zone)}</td>
