...
const StatCard: React.FC<{ icon: string; value: number | string; label: string }> = ({ icon, value, label }) => (
  <div className="bg-dark-800 p-6 rounded-lg shadow-lg flex flex-col items-start gap-4 sm:flex-row sm:items-center">
      <div className="w-16 h-16 p-3 flex items-center justify-center bg-dark-700 rounded-full mb-2 sm:mb-0">
          <Icon className="text-3xl text-brand-accent">{icon}</Icon>
      </div>
      <div>
