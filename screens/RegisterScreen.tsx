                     ...
                     <div className="flex items-start">
                        <div className="flex items-center h-5">
                            <input
                                ...
                                className="h-4 w-4 text-brand-primary bg-dark-700 border-dark-600 focus:ring-brand-primary rounded"
                                required
                            />
                        </div>
                        <div className="ml-3 text-sm">
                            <label htmlFor="terms-agreement" className="text-dark-text-secondary">
                                ...
                                className="font-medium text-brand-secondary hover:text-brand-primary underline"
                                >
                                User Agreement
                                </button>
                                .
